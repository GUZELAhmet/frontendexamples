...
const headEl=document.querySelector("h1"); // sadece ilk eşleştiği elemanı seçer
...
spanEls[0].innerText="değiştir";

// Listenin ikinci elamanı alıp  son elamanına ekleyen  kod
